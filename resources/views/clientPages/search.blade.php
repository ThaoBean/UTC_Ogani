            ...
            <div class="row">
              <div class="col-lg-12 text-center">
                <div class="breadcrumb__text">
                  <h2>Products you are looking for</h2>
                </div>
              </div>
            </div>
          </div>
...
<section class="related-product">
  <div class="container">
        ...
        <div class="product__item">
          <div class="product__item__pic set-bg" data-setbg="{{URL::to('storage/images/'.$item->image)}}">
            <ul class="product__item__pic__hover">
              ...
              <li>
              <form method="post" action="{{URL::to('/add-to-cart/'.$item->id)}}">
    ...
    @else
      <p style="color:red; text-align:center; margin-top: 30px;">No result is found!!!</p>
    @endif
  </div>
</section>
