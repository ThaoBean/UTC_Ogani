            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price">{{number_format($product->price - $product->quantity*0.1, 0)}}đ</div>
                        <p>{{$product->short_desc}}</p>
                        @if($product->quantity > 0)
                        <div class="product__details__quantity">
                            <div class="quantity">
                                <div class="pro-qty">
                                    <input type="number" min="1" max="{{$product->quantity}}" oninput="validity.valid||(value='1')"  value="1">
                                </div>
                            </div>
                        </div>
              ...
              <div class="col-lg-3 col-md-4 col-sm-6">
                  <div class="product__item">
                      ...
                      <div class="product__item__text">
                          ...
                          <h5>{{number_format($product->price - $product->quantity*0.1, 0)}}đ</h5>
                      </div>
                  </div>
              </div>
            @endforeach
